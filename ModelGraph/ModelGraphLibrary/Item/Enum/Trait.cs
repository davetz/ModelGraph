...
namespace ModelGraphLibrary
{
    ...
    public enum Trait : ushort
    {
        ...
        ValueXNativeType_P = 0x474 | IsReadOnly,
        ...
        ComputeXNativeType_P = 0x4B7 | IsReadOnly,
        ...
        NativeType_None = 0x840,
        NativeType_Bool = 0x841,
        NativeType_Byte = 0x842,
        NativeType_Int16 = 0x843,
        NativeType_Int32 = 0x844,
        NativeType_Int64 = 0x845,
        NativeType_Double = 0x846,
        NativeType_String = 0x847,
        NativeType_Invalid = 0x848,
        NativeTypeEnum = 0x87F,
