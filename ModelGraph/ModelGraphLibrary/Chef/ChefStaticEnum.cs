 ...
 */
    public partial class Chef
    {
        ...
        EnumZ _nativeTypeEnum;

        private void InitializeEnums()
        {
            _valueTypeEnum = new EnumZ(_enumZStore,Trait.ValueTypeEnum, typeof(ValueType));
            ...
            new PairZ(_nativeTypeEnum, Trait.NativeType_Int16);
            new PairZ(_nativeTypeEnum, Trait.NativeType_Int32);
            new PairZ(_nativeTypeEnum, Trait.NativeType_Int64);
            new PairZ(_nativeTypeEnum, Trait.NativeType_Double);
            new PairZ(_nativeTypeEnum, Trait.NativeType_String);
            new PairZ(_nativeTypeEnum, Trait.NativeType_Invalid);
        }
    }
}
