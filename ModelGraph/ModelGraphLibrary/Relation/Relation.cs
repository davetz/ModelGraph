...
namespace ModelGraphLibrary
{
    ...
    {
        internal Guid Guid;
        internal short MinOccurance;
        internal short MaxOccurance;
        ...
        internal abstract void InsertLink(Item parentItem, Item childItem, IndexPair index);
        internal abstract IndexPair AppendLink(Item parentItem, Item childItem);
        internal abstract IndexPair GetIndex(Item parentItem, Item childItem);
